...
import com.example.ui.components.ClickableIcon
        ...
        Column(
            ...
            HorizontalPager(count = allMoods.size, state = pagerState) { page ->
                AsyncImage(
                    ...
                    model = ImageRequest.Builder(context).data(allMoods[page].icon).crossfade(true)
                        .build(),
    ...
    Box(modifier = Modifier.pointerInput(Unit) {
        ...
        AsyncImage(
            ...
            model = ImageRequest.Builder(LocalContext.current)
                .data(selectedGalleryImage.imageUri.toString()).crossfade(true).build(),
